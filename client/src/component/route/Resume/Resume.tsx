...
const Resume = () => {
  ...
  const workExperience = [
    ...
    },
    {
      ...
      description:
        'Creating the API that will receive the coding test results from students on the website and reformat the Python file templates via Python AST for further purposes. Additionally, participated in front-end page development and implemented back-end APIs’ logic. ',
    },
  ]
  return (
    <div className="resume-container">
      <header className="child-hierarchy App-header-resume">
        ...
        <span className="resume-section-intro">
          …Over 4 years of experience in web development, with strong eager of
        ...
        <section className="skills-section">
          ...
          <div className="skills">
            <div className="traits-container">
              ...
              <span>
                ...Proficient in web development with MERN stack. Has many
                hands-on projects development experience. Specialized in
                applying methodologies into development such as MVC and
                RESTFulAPI. Experienced on complex software architecture design
                for both front-end and back-end, such as microservices.
              </span>
            </div>
            <div className="traits-container">
              <span>&#123;!&#125;</span>
              ...
              <span>
                ...Can use these skills to write clean and resuable code for
                front-end to present a beautiful UI with both static and dynamic
                effects. Be able to write complex components for reuse purposes.
                Expert in front-end architecture design and route design.
              </span>
            </div>
            <div className="traits-container">
              <span>&#123;#&#125;</span>
              ...
              <span>
                ...Experienced in both non-relational database and relational
                database. Skilled in SQL, including DDL and DML operations, also
                experienced in performing CRUD operations and managing complex
            ...
            <div className="traits-container">
              ...
              <span>
                ...Experienced in microservices implementation with docker.
                Applied ci/cd pipeline and cloud deployment for each services
                with gcp.
              </span>
            </div>
          </div>
